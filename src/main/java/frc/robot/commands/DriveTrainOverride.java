...
public class DriveTrainOverride extends AutoFollower {
  /** Creates a new DriveTrainOverride. */
  public DriveTrainOverride() {
  ...
  public int getPathPointIndex() {
    ...
    throw new UnsupportedOperationException("Unimplemented method 'getPathPointIndex'");
  }
